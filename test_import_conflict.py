"""Test PyQt6 first, then MediaPipe import order."""
...
def test_imports():
    print("=" * 50)
    print("Testing import order: PyQt6 first, then MediaPipe")
    print("=" * 50)

    # Test 1: Import PyQt6 first
    try:
    ...
    # Test 2: Import MediaPipe after PyQt6
    try:
